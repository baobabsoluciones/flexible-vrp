...
dict2_param = sheet_param.set_index('name')['value'].to_dict()
df_param = sheet_param.to_records() #Crea una matriz con el índice, el nombre del parámetro y el valor
print(sheet_param)
print(" \n")
print(dict2_param)
print(" \n")
...
dict1={'dict_param': dict2_param,'dict_warehouse': dict_warehouse,'dict_trip_duration':dict_trip_duration,\
