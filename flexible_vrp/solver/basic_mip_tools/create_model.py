...
def create_model():
    ...
    def fc5_max_unload_total_comm(model, v, s, w, origin, destination, quantity, compulsory):
        if destination == w:
    ...
    def fc6_max_load_total_comm(model, v, s, w,  origin, destination, quantity, compulsory):
        if origin == w:
    ...
    def fc23_single_warehouse_per_stop(model, v, s):
    ...
    model.c5_max_unload_total_comm = Constraint(model.sVehicles, model.sStops, model.sWarehouses, model.sCommodities,
                                                rule=fc5_max_unload_total_comm)
    # model.c6_max_load_total_comm = Constraint(model.sVehicles, model.sStops, model.sWarehouses, model.sCommodities,
    #                                             rule=fc6_max_load_total_comm)
    ...
    model.c23_single_warehouse_per_stop = Constraint(model.sVehicles, model.sStops, rule=fc23_single_warehouse_per_stop)
