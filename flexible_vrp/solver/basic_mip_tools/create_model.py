...
def create_model():
    ...
    model.c13_simultaneidad_veh_1 = Constraint(model.sVehicles, model.sStops, model.sVehicles, model.sStops,
                                               rule=fc13_simultaneidad_veh_1)
    model.c14_simultaneidad_veh_2 = Constraint(model.sVehicles, model.sStops, model.sVehicles, model.sStops,
                                               rule=fc14_simultaneidad_veh_2)
